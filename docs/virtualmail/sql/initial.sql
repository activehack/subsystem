...
CREATE INDEX domains_index1 ON domains USING btree (status);
CREATE INDEX domains_index2 ON domains USING btree (domain, status);
CREATE INDEX list_account_index1 ON list_accounts USING btree (status, name, domain);
CREATE INDEX list_member_index1 ON list_members USING btree (list_account, status);
